...
func (d *Driver) Load(ctx context.Context, schemaPath, dataPath string) error {
...
func (db *Driver) LoadData(inCtx context.Context, dataDir string) error {
